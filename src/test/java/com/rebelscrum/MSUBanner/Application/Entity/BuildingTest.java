...
public class BuildingTest {
    ...
    public void setAddress() throws Exception{
        Building tester = new Building();
        assertNull("This test should pass when there is not Building address", tester.getAddress());
        tester.setAddress("1234 Auraria");
        assertNotNull("The Building has an address", tester.getAddress());
